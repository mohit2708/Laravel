    ...
    //	dd($request);
		...
		try{
			DB::beginTransaction();
			   ...
			   $routeinfo->ip_address  	  = trim($request->ip_address);
			   $routeinfo->device_serial  = trim($request->device_serial_number);
			   ...
			   DB::commit();
			   return redirect('route-list')->with('success', 'Route Information Added Successfully');
