     ...
     <div class="row">
	   ...
	   @include('includes.notifications')
			<div class="box box-info">
				...
				<div class="box-body">
					<form action ="{{url('admin/acl/module/store')}}" class="form-horizontal" id="validForm" method="POST">
						{!! csrf_field() !!}
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="module_title" class="form-control" value="{{ Request::old('module_title') }}" placeholder="Module Title">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="col-sm-12">
										<label>Icon</label>
										<input type="text" name="icon" class="form-control" value="{{ Request::old('icon') }}" placeholder="Icon">
										@if ($errors->has('icon'))
