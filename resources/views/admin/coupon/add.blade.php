     ...
     <div class="row">
	   ...
	   @include('includes.notifications')
			<div class="box box-info">
				...
				<div class="box-body">
					<form action ="{{url('admin/coupon/store')}}" class="form-horizontal" id="validForm" method="POST">
						{!! csrf_field() !!}
						<div class="row">
...
<div class=" input-group">
										<input type="text" name="coupon_code" class="form-control" value="{{ Request::old('coupon_code') }}" placeholder="Coupon Code" rel="gp" data-size="32" data-character-set="a-z,A-Z,0-9,#" readonly="readonly">
