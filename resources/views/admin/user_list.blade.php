            ...
            <div class="table-wrapper">
               <div class="table-title">
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        <a href="#addUserModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-plus"></i> <span>Add New Employee</span></a>
                  ...
                  <tbody>
                    @foreach($showUserList as $showuser)
                     <tr>
                        ...
                        <td>{{ ucfirst($showuser->name) }}</td>
                        <td>{{ $showuser->email }}</td>
                        <td>{{ $showuser->email_verified_at === null ? "--" : $showuser->email_verified_at}}</td>
                        <td>(171) 555-2222</td>
                        <td>
