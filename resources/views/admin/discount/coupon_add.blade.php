	  ...
	  <div class="nav-tabs-custom">
		...
		<div class="tab-content no-padding">
		  ...
		  <div class="chart tab-pane active" style="position: relative; overflow: auto">
		  	<br>
			  <div class="col-md-12">
			  	<form action ="{{url('admin/discount/coupon/store')}}" class="form-horizontal" id="validForm" method="POST">
						{!! csrf_field() !!}
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="coupon_name" class="form-control" value="{{ Request::old('coupon_name') }}" placeholder="Coupon Name">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<div class=" input-group">
										<input type="text" name="coupon_code" class="form-control" value="{{ Request::old('coupon_code') }}" placeholder="Coupon Code" rel="gp" data-size="8" data-character-set="a-z,A-Z,0-9,#" readonly="readonly">
