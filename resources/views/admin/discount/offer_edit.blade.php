	  ...
	  <div class="nav-tabs-custom">
		...
		<div class="tab-content no-padding">
		  ...
		  <div class="chart tab-pane active" style="position: relative; overflow: auto">
		  	<br>
			  <div class="col-md-12">
			  	<form action ="{{url('admin/discount/offer/update/'.$arrDiscountOffer->id)}}" class="form-horizontal" id="validForm" method="POST">
						{!! csrf_field() !!}
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="offer_name" class="form-control" value="{{ $arrDiscountOffer->offer_name }}" placeholder="Offer Name">
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<div class="input-group">
											<input type="text" name="start_date" class="form-control start-date" placeholder="Start Date" value="{{ date('d/m/Y H:i', strtotime($arrDiscountOffer->start_date)) }}" />
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="end_date" class="form-control end-date" placeholder="End Date" value="{{ date('d/m/Y H:i', strtotime($arrDiscountOffer->end_date)) }}" />
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="discount_percent" class="form-control" value="{{ $arrDiscountOffer->discount_percent }}" placeholder="Discount %">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="upto" class="form-control" value="{{ $arrDiscountOffer->upto }}" placeholder="Up To Discount">
										@if ($errors->has('upto'))
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="min_price" class="form-control" value="{{ $arrDiscountOffer->min_price }}" placeholder="Price">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="per_person" class="form-control" value="{{ $arrDiscountOffer->per_person }}" placeholder="U/1/2/3">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="text" name="max_person" class="form-control" value="{{ $arrDiscountOffer->max_person }}" placeholder="U/1/2/3">
								...
								<div class="form-group">
									...
									<select class="multiple" name="service[]" multiple="multiple">
										@foreach($arrServices as $service)
											<option value="{{$service->id}}" {{ (isset($arrDiscountOffer)) ? (in_array($service->id, DiscountController::getServicesID($arrDiscountOffer->id))) ? 'selected' : '' : '' }}  >{{$service->service_name}}</option>
										@endforeach
									</select>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="col-sm-12">
										...
										<textarea class="form-control" name="term_and_cond" placeholder="Terms and Conditions" rows="5">{{ $arrDiscountOffer->term_and_cond }}</textarea>
