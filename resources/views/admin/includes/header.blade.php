...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{ asset('theme/dist/css/bootstrap.min.css') }}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('theme/dist/css/font-awesome.min.css') }}">
  <!-- Ionicons -->
  ...
  <link rel="stylesheet" href="{{ asset('theme/dist/css/_all-skins.min.css') }}">
