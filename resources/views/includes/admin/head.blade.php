<head>
  ...
  <title>@yield('title') | MakeusFly</title>
  ...
  <link rel="stylesheet" href="{{ asset('public/assets/dist/css/skins/skin-blue.css')}}">

<link rel="stylesheet" href="{{ asset('public/assets/dist/css/style.css')}}">
<link rel="stylesheet" href="{{ asset('public/assets/dist/css/bootstrap-multiselect.css')}}">
