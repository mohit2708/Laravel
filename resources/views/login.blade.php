...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('public/assets/plugins/Ionicons/css/ionicons.min.css')}}">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ url('/') }}"><img src="{{ asset('public/assets/dist/img/logo.png')}}" width="200"></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <!-- /.social-auth-links -->
    <a href="#" class="text-right" style="display: block;">I forgot my password</a>
  </div>
  <!-- /.login-box-body -->
</div>
  <div class="text-center">&copy; {{ date('Y') }} Alivenet.</div>
<!-- /.login-box -->
